...
DATA_PATH2 = r'C:\Users\Rahul Chawla\Desktop\Universiy\NVD\NVD-aloy\vidsblurred\vidsblurred_good\testing'
#dp =         r'C:\Users\Rahul Chawla\Desktop\Universiy\NVD\NVD-aloy\vidsblurred\vidsblurred_good\model_evaluation\fm_baby1'
    ...
    for vid in os.listdir(action_dir):
        ...
        if len(sequence) == 250:
            ...
            if(actions[np.argmax(res)] == action):
                correct = correct+1
                if(actions[np.argmax(res)] == 'cramped_synchronized'):
